    ...
    const billHtml = `
        <div style="padding: 10px; font-family: Arial, sans-serif;">
            <div style="text-align: center; border-bottom: 2px solid #000; padding-bottom: 10px; margin-bottom: 15px;">
                <h2 style="margin: 0; text-transform: uppercase;">SINGH PATHOLOGY PAYMENT RECEIPT</h2>
            </div>
            ...
            <div style="display: flex; justify-content: flex-end; align-items: center; margin-top: 30px;">
                <div style="text-align: right;">
                    ...
                    <p style="margin: 3px 0; font-size: 11px;">SINGH Pathology Lab</p>
                    <p style="margin: 3px 0; font-size: 11px;">Mo n. 7651839528</p>
                </div>
            </div>
